import type { LogEntry, TestItem } from '@cnv-monitor/shared';
...
export const fetchTestItemLogs = (
  itemId: number,
  level = 'ERROR',
): Promise<{ content: LogEntry[]; page: { totalElements: number } }> =>
...
export type StreakInfo = {
  ...
  recentRuns: { status: string; date: string }[];
};
