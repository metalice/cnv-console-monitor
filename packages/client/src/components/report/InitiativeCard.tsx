...
export const InitiativeCard = ({ initiative }: InitiativeCardProps) => {
  ...
  return (
    <Card className={`app-report-initiative app-report-initiative--${initiative.status}`}>
      <CardTitle>
      ...
      <CardBody>
        ...
        {initiative.contributors.length > 0 && (
          <Content className="app-report-contributors" component="small">
