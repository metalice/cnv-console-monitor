...
export const PersonCard = ({ editable = false, onNotesChange, personReport }: PersonCardProps) => {
  ...
  return (
    <Card
      className={`app-report-person${personReport.excluded ? ' app-report-person--excluded' : ''}`}
    >
      <CardHeader>
        <Flex
      ...
      <CardBody>
        {personReport.aiSummary && (
          <Content className="app-report-ai-summary" component="p">
        ...
        {editable && (
          <div className="app-report-notes">
            <TextArea
